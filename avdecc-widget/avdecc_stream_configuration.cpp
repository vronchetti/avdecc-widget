...
/**
* avdecc_stream_configuration.cpp
*
*/
...
avdecc_stream_configuration::avdecc_stream_configuration(avdecc_lib::end_station * end_station, avdecc_lib::system * sys)
{
...
avdecc_stream_configuration::~avdecc_stream_configuration() {}

int avdecc_stream_configuration::get_avdecc_stream_input_details_by_index(unsigned int index, struct avdecc_stream_configuration_details &stream_details)
{
...
int avdecc_stream_configuration::get_avdecc_stream_output_details_by_index(unsigned int index, struct avdecc_stream_configuration_details &stream_details)
{
...
int avdecc_stream_configuration::get_dialog_stream_input_details_by_index(unsigned int index, struct avdecc_stream_configuration_details &stream_details)
{
	if (index >= m_stream_input_count)
		return -1;
...
int avdecc_stream_configuration::get_dialog_stream_output_details_by_index(unsigned int index, struct avdecc_stream_configuration_details &stream_details)
{
	if (index >= m_stream_output_count)
		return -1;
...
int avdecc_stream_configuration::GetStreamInfo()
{
	avdecc_lib::entity_descriptor *entity;
	avdecc_lib::configuration_descriptor *configuration;
	get_current_entity_and_descriptor(m_end_station, &entity, &configuration);
...
int avdecc_stream_configuration::GetAudioMappings()
{
	avdecc_lib::entity_descriptor *entity;
	avdecc_lib::configuration_descriptor *configuration;
	get_current_entity_and_descriptor(m_end_station, &entity, &configuration);
...
int avdecc_stream_configuration::SetStreamInfo()
{
	avdecc_lib::entity_descriptor *entity;
	avdecc_lib::configuration_descriptor *configuration;
	get_current_entity_and_descriptor(m_end_station, &entity, &configuration);
	...
	{
		struct avdecc_stream_configuration_details avdecc_stream_input_details;
		struct avdecc_stream_configuration_details dialog_stream_input_details;
	...
	{
		struct avdecc_stream_configuration_details avdecc_stream_output_details;
		struct avdecc_stream_configuration_details dialog_stream_output_details;
...
int avdecc_stream_configuration::SetAudioMappings()
{
	avdecc_lib::entity_descriptor *entity;
	avdecc_lib::configuration_descriptor *configuration;
	get_current_entity_and_descriptor(m_end_station, &entity, &configuration);
...
uint64_t avdecc_stream_configuration::channel_count_and_sample_rate_to_stream_format(unsigned int channel_count, uint32_t sampling_rate)
{
...
int avdecc_stream_configuration::cmd_set_name(std::string desc_name, uint16_t desc_index, std::string new_name)
{
...
int avdecc_stream_configuration::cmd_display_desc_name(avdecc_lib::descriptor_base *desc, uint16_t name_index, bool is_entity)
{
	uint8_t * name;
	avdecc_lib::entity_descriptor *entity;
	avdecc_lib::configuration_descriptor *configuration;
...
int avdecc_stream_configuration::add_audio_mappings(uint16_t desc_type)
{
...
int avdecc_stream_configuration::remove_audio_mappings(uint16_t desc_type)
{
	avdecc_lib::entity_descriptor *entity;
	avdecc_lib::configuration_descriptor *configuration;
	if (get_current_end_station_entity_and_descriptor(&m_end_station, &entity, &configuration))
...
int avdecc_stream_configuration::cmd_set_stream_format(wxString desc_name, uint16_t desc_index, uint64_t stream_format_value)
{
...
int avdecc_stream_configuration::get_current_entity_and_descriptor(avdecc_lib::end_station *end_station,
...
uint32_t avdecc_stream_configuration::get_next_notification_id()
{
	return (uint32_t)notification_id++;
}

int avdecc_stream_configuration::get_current_end_station_entity_and_descriptor(avdecc_lib::end_station **end_station,
	avdecc_lib::entity_descriptor **entity, avdecc_lib::configuration_descriptor **configuration)
{
